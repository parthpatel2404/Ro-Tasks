...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PCI148\\SQL2017;DataBase=CIPlatform;User ID=sa;Password=Tatva@123;Encrypt=False;TrustServerCertificate=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA4141EE9B5CE8");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C34FDE03930");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A888094DDD");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52E16A8988");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7957687E3771C9A");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD055E278B589");
        ...
        {
            entity.HasKey(e => e.FavoriteMissionId).HasName("PK__favorite__B4CF3312A25ADCAD");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7600D0116");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB20AB23A73");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A82031F23");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC8D61C23C5");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED158974946BD");
            ...
            entity.HasOne(d => d.ToUser).WithMany(p => p.MissionInvites)
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E856E4B4CE");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E5172930CC669");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_r__missi__09746778");

            entity.HasOne(d => d.User).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_r__user___0880433F");
        });

        modelBuilder.Entity<MissionSkill>(entity =>
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008BC782CC3");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5AC8D41A7DE");
        ...
        {
            entity.HasKey(e => e.NotificattionSettingsId);

            entity.ToTable("Notification_Settings");

            entity.Property(e => e.NotificattionSettingsId).HasColumnName("notificattion_settings_id");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.NotificationSettings)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Notification_Settings_user_id");
        });

        modelBuilder.Entity<PasswordReset>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__password__3213E83FFF935DCA");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA83793B46AE6D");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C56F3C6AEE8");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__0449786703C0C8A1");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C94427547");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF506819A799B5");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370F98732BB9");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576BA34CFC3A");
